...
//                            String id=imageList.get(position).getActivityId()+""+imageList.get(position).getOrganizerId();
    ...
    public MyActivityAdapter(Context mContext, List<Activity> activityList, SharedPreferences sharedPreferences) {
    ...
    public MyActivityAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MyActivityAdapter.MyViewHolder(itemView);
    }
