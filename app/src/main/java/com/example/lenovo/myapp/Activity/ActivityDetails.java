...
import com.example.lenovo.myapp.Adapter.ActivityDetailPageAdapter;
import com.example.lenovo.myapp.Auxiliaries.Constants;
import com.example.lenovo.myapp.Classes.Activity;
import com.example.lenovo.myapp.Classes.Images;
import com.example.lenovo.myapp.Classes.Location;
import com.example.lenovo.myapp.Classes.PublicReviews;
import com.example.lenovo.myapp.Classes.Service;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkavailabily.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = i.putExtra("activityId", actId);
